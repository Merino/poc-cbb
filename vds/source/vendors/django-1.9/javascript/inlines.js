...
(function($) {
    ...
    $.fn.formset = function(opts) {
        ...
        if ($this.length && showAddButton) {
            ...
            if ($this.prop("tagName") === "TR") {
                ...
                $parent.parent().append('<tfoot><tr class="' + options.addCssClass + '"><td colspan="' + numCols + '"><a href="#">' + options.addText + "</a></tr></tfoot>");
                addButton = $parent.parent().find("tr:last a");
            } else {
    ...
    $.fn.formset.defaults = {
        ...
        emptyCssClass: "add-row",    // CSS class applied to the empty row
